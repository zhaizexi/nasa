      ...
      <div className="relative pt-16 px-4 xl:px-0">
        ...
        >
          {news.map((news, index) => (
            <SwiperSlide
              key={index}
              className="pr-10 group -translate-x-1/2 cursor-pointer"
            >
              ...
              <div className="bg-gray-dark relative mb-6 overflow-hidden lg:mb-10 aspect-video">
                <Image
                  className="transition-all duration-300 scale-105 delay-200 group-hover:scale-100"
                  src={news.img}
                  alt={news.title}
                  priority={false}
                  unoptimized
              ...
              <div className="transition-all duration-300 delay-200  group-hover:-translate-y-5">
              ...
              <div className="absolute bottom-0 text-jpl-red -translate-x-4 delay-200 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 text-2xl leading-normal transition duration-300 ">
                  <svg
                    width="26"
                    height="16"
                    viewBox="0 0 26 16"
